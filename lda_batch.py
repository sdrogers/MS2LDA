...
# beer negative mode
run_lda('beer_neg', 'input/QCBeerT10_neg.csv', True, n_topics)
run_lda('beer_neg', 'input/QCBeerT10_neg.csv', False, n_topics)
...
run_lda('urine37_pos', 'input/Urine37_T10mixed_pos.csv', True, n_topics)
run_lda('urine37_pos', 'input/Urine37_T10mixed_pos.csv', False, n_topics)

# urine37 negative mode
run_lda('urine37_neg', 'input/Urine37_T10mixed_neg.csv', True, n_topics)
run_lda('urine37_neg', 'input/Urine37_T10mixed_neg.csv', False, n_topics)
...
run_lda('urine94_pos', 'input/Urine94_T10mixed_pos.csv', True, n_topics)
run_lda('urine94_pos', 'input/Urine94_T10mixed_pos.csv', False, n_topics)

# urine94 negative mode
run_lda('urine94_neg', 'input/Urine94_T10mixed_neg.csv', True, n_topics)
run_lda('urine94_neg', 'input/Urine94_T10mixed_neg.csv', False, n_topics)
