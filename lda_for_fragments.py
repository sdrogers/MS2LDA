...
#             self.docdf.ix[:, i] = selected
    ...
    def plot_lda_fragments(self, consistency=0.50, sort_by="h_index", 
        ...
        if interactive:
            ...
            data = {}
            data['topic_term_dists'] = self.topic_word
            data['doc_topic_dists'] = self.doc_topic
            ...
            data['lambda_step'] = 5         
            data['lambda_min'] = utils._round_nicely(plotter.sort_by_min)
            data['lambda_max'] = utils._round_nicely(plotter.sort_by_max)
