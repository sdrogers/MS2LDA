...
atom_valences = {'C':4,'H':1,'N':3,'O':2,'P':3,'S':2}

class golden_rules(object):

	def __init__(self,rule_switch = [True,True,True,True,True,True,True]):
	...
	def rule1(self,formula):
		...
		if mass < 500:
		    if self.element_numbers_restriction(formula, 39, 72, 20, 20, 9, 10, 16, 10, 5):
		        return False
		elif mass < 1000:
